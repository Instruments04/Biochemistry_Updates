...
"background-color: transparent;"));
        ...
        lineEdit->setGeometry(QRect(290, 5, 221, 31));
        QFont font;
        ...
        stackedWidget_8->setGeometry(QRect(40, 40, 731, 230));
...
"}"));
        ...
        frame_2->setGeometry(QRect(250, 0, 221, 225));
...
""));
        ...
        pushButton_127->setGeometry(QRect(80, 170, 61, 50));
...
"}"));
        ...
        pushButton_125->setGeometry(QRect(10, 170, 61, 50));
...
"}"));
        ...
        pushButton_128->setGeometry(QRect(150, 170, 61, 50));
...
"}"));
        ...
        pushButton_128->raise();
        pushButton_127->raise();
        pushButton_118 = new QPushButton(page);
        pushButton_118->setObjectName(QStringLiteral("pushButton_118"));
        pushButton_118->setGeometry(QRect(330, 115, 61, 50));
...
"}"));
        ...
        pushButton_120->setGeometry(QRect(260, 5, 61, 50));
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0.0913636, x2:0.944, y2:0.392, stop:0.0969388 rgba(22, 123, 200, 255), stop:1 rgba(20, 113, 180, 255));\n"
"}"));
        pushButton_119 = new QPushButton(page);
        pushButton_119->setObjectName(QStringLiteral("pushButton_119"));
        pushButton_119->setGeometry(QRect(260, 60, 61, 50));
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0.0913636, x2:0.944, y2:0.392, stop:0.0969388 rgba(22, 123, 200, 255), stop:1 rgba(20, 113, 180, 255));\n"
"}"));
        pushButton_126 = new QPushButton(page);
        pushButton_126->setObjectName(QStringLiteral("pushButton_126"));
        pushButton_126->setGeometry(QRect(260, 115, 61, 50));
...
"}"));
        ...
        pushButton_122->setGeometry(QRect(400, 60, 61, 50));
...
"}"));
        ...
        pushButton_117->setGeometry(QRect(330, 60, 61, 50));
...
"}"));
        ...
        pushButton_123->setGeometry(QRect(400, 5, 61, 50));
...
"}"));
        ...
        pushButton_121->setGeometry(QRect(330, 5, 61, 50));
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0.0913636, x2:0.944, y2:0.392, stop:0.0969388 rgba(22, 123, 200, 255), stop:1 rgba(20, 113, 180, 255));\n"
"}"));
        pushButton_124 = new QPushButton(page);
        pushButton_124->setObjectName(QStringLiteral("pushButton_124"));
        pushButton_124->setGeometry(QRect(400, 115, 61, 50));
